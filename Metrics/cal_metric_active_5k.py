...
def get_parser():
    ...
    parser.add_argument('--ref_smiles', default="/ScaffoldInvent/data/parp1/parp1_candidates.smi", type=str,
    ...
    parser.add_argument('--gen_path',default='/ScaffoldInvent/data/parp1/parp1_sample_5k.csv',type=str, required=False,help='Path to generated molecules csv')
    parser.add_argument('--output',default='/ScaffoldInvent/data/parp1/parp1_metrics_5k.csv',type=str, required=False,help='Path to save results csv')
