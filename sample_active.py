...
parser.add_argument('--batch-size', type=int, default=512, metavar='N',help='Input batch size for training ')
parser.add_argument('--epochs', type=int, default=400, metavar='N',help='Number of epochs to sample')
parser.add_argument('--molecule_num', type=int, default=100000, metavar='N',help='sample number')
