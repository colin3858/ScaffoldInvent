...
parser.add_argument('--molecule_num', type=int, default=100, metavar='N',help='sample number')
...
def main(args):
    ...
    if torch.cuda.is_available():
        dmpn.load_state_dict(torch.load(args.modelPath)['model'])
